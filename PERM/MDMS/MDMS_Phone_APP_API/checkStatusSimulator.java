...
public class checkStatusSimulator {
 ...
 public static void main(String[] arg){
  ...
  try {
   ...
   for(int cnt = startMdn ; cnt <= endMdn ; cnt++){
    ...
    String urlStr = "http://"+_path+":18080/api/10/A/checkStatus?pg_proc_id=DS&pg_host=PG51&if_id=&push_id=&mdn=84523287ec91db320e01437f763f6a7c&rat_type=L";
