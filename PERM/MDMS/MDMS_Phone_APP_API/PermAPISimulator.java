        ...
        public static void main(String[] arg){ 
                ...
                try { 
                        ...
                        for(int cnt = 0 ; cnt < maxCnt ; cnt++){ 
                                ...
                                String urlStr = "http://"+_path+":18080/api/checkStatus?mdn=84523287ec91db320e01437f763f6a7c&tid=UPM01_01&push_id=1&branch_name=SS&stmp_host=STMP01&rat_type=S";
                                ...
                                urlStr = "http://"+_path+":18080/api/updatePushStatus?if_id="+tid+"&result_code=S&stmp_host=STMP01&branch_name=SS&push_type=AOM&push_id=&mdn="; 
                                RequestAPI updateStatus = new RequestAPI(urlStr, mdn); 
                                EXECUTOR_SERVICE.execute(updateStatus);
                                _cnt++; 
                                if(_cnt%600 == 0){ 
                                        System.out.println("Information) Sucess : " + cnt + " - Time : " +new Date().toString()); 
                                }
                        }
